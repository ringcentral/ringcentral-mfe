...
// source code from `https://github.com/omichelsen/compare-versions`
// !!! DO NOT MODIFY THIS FILE !!!
// !!! Ensure that `satisfiesVersion` is serializable.
export function satisfiesVersion(version: string, range: string) {
   ...
   * ```
   */
  const compare = (v1: string, v2: string, operator: CompareOperator) => {
